        ...
        <div className="min-h-[70vh] md:min-h-screen flex flex-col p-8 md:p-16 pt-24 md:pt-32">
          <div className="flex-1 flex items-start">
            <div className="flex items-start gap-1">
              <span className="text-sm mt-2" aria-hidden="true">©</span>
              <AnimatedHeader>
                <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter">
                  <span ref={addToLineRefs} className="block" aria-hidden="false">
                    LUQMAN
                  </span>
                  <span ref={addToLineRefs} className="block" aria-hidden="false">
                    ISMAT
          ...
          <div className="scroll-content space-y-16">
            ...
            <div className="space-y-6 text-lg md:text-xl text-muted-foreground">
              <p>
                ...
                <Link href="/blog/epc-lifecycle" className="text-foreground underline-offset-4 hover:underline font-medium">
                  EPC lifecycle
                </Link>
                {" "}from concept to operation, with a focus on{" "}
                <Link href="/blog/detailed-engineering" className="text-foreground underline-offset-4 hover:underline font-medium">
                  detailed engineering
                </Link>
                {" "}and{" "}
                <Link href="/blog/process-piping-systems" className="text-foreground underline-offset-4 hover:underline font-medium">
                  systems engineering
                </Link>
                .
              </p>
              <p>
                ...
                <Link href="/blog/epc-estimating" className="text-foreground underline-offset-4 hover:underline font-medium">
                  cost management
                </Link>
                {" "}and{" "}
                <Link href="/blog/epc-communication" className="text-foreground underline-offset-4 hover:underline font-medium">
