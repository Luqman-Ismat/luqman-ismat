...
const blogPosts = [
  ...
  },
  {
    ...
    description: "A comprehensive guide to Process Safety Management, HAZOP, LOPA, and risk assessment methodologies for ensuring safety in industrial facilities.",
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/blake-connally-IKUYGCFmfw4-unsplash.jpg-0z59RONP3VknWJW7WTTxt5BTdr6NFr.jpeg",
    description: "Discover how digital twin technology is revolutionizing engineering through virtual replicas, real-time monitoring, and predictive capabilities.",
  ...
  },
  {
    ...
    description: "A comprehensive guide to heat exchanger design principles, types, thermal calculations, and selection criteria for optimal performance.",
  ...
  },
  {
    ...
    category: "PROJECT MANAGEMENT",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/product-school-XZkk5xT8Xrk-unsplash%20(1).jpg-xdC0zNLpYvZV5amqGy0gWaBLGJa5ny.jpeg",
    description: "Master the essential project management skills that every engineering professional needs, from planning to stakeholder management.",
  ...
  },
  {
    ...
    category: "PROCESS ENGINEERING",
    image: "/images/detailed-engineering-blog.jpeg",
    description: "Comprehensive guide to process piping design including pipe sizing, materials selection, and pressure drop optimization.",
  ...
  },
  {
    ...
    category: "ENGINEERING TECHNOLOGY",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/blake-connally-IKUYGCFmfw4-unsplash.jpg-0z59RONP3VknWJW7WTTxt5BTdr6NFr.jpeg",
    description: "Discover how AI and ML are revolutionizing engineering through optimization algorithms, predictive analytics, and intelligent automation.",
  ...
  },
  {
    ...
    category: "PROCESS ENGINEERING",
    image: "/images/detailed-engineering-blog.jpeg",
    description: "Comprehensive guide to improving energy efficiency through pinch analysis, waste heat recovery, and advanced optimization techniques.",
  ...
  },
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/product-school-XZkk5xT8Xrk-unsplash%20(1).jpg-xdC0zNLpYvZV5amqGy0gWaBLGJa5ny.jpeg",
    description: "Strategic guidance for advancing your engineering career through certifications, networking, continuous learning, and leadership roles.",
  ...
  },
  {
    ...
    description: "Understanding why precise estimation is the backbone of successful EPC project execution, from conceptual estimates to detailed cost analysis.",
  ...
  },
  {
    ...
    description: "A comprehensive guide to the Engineering, Procurement, and Construction lifecycle, from initial concept to final operation.",
  ...
  },
  {
    ...
    category: "ENGINEERING TECHNOLOGY",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/blake-connally-IKUYGCFmfw4-unsplash.jpg-0z59RONP3VknWJW7WTTxt5BTdr6NFr.jpeg",
    description: "An in-depth analysis of engineering technology's current state, examining progress, challenges, and the path forward in digital transformation.",
  ...
  },
  {
    ...
    category: "EPC LIFECYCLE",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/product-school-XZkk5xT8Xrk-unsplash%20(1).jpg-xdC0zNLpYvZV5amqGy0gWaBLGJa5ny.jpeg",
    description: "Explore how effective communication shapes EPC project success, and learn strategies to overcome common communication challenges in complex engineering projects.",
