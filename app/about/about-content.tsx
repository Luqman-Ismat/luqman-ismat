              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div className="space-y-6 text-muted-foreground">
                  ...
                  <p>
                    ...
                    <Link href="/blog/process-safety-management" className="text-foreground underline-offset-4 hover:underline">
                      HAZOP and HAZIP studies
                    </Link>
                    , developed P&IDs, ran Aspen HYSYS
                    ...
                    (P&ID) and Piping Material Specifications (PIP) for{" "}
                    <Link href="/blog/process-piping-systems" className="text-foreground underline-offset-4 hover:underline">
                      PTFE-lined piping in acidic water service
                    </Link>
