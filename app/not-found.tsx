...
export default function NotFound() {
  return (
    <div className="flex flex-col min-h-screen w-full bg-background text-foreground">
      <Header />
      <main id="main" className="relative flex-1 w-full flex items-center overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 dot-grid dot-grid-drift opacity-50" />
        <div className="relative container px-4 py-24 md:py-32">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[0.95]">
              <LetterStagger text="LOST" baseDelay={60} className="block" />
              <LetterStagger text="SIGNAL." baseDelay={260} className="block" />
            </h1>
